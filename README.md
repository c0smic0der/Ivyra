...
**Caliber is the combination neither side ships: a decision journal with an un-fakeable measurement core** — reasoning capture + proper scoring + AI post-mortems.

> _"Decision Log helps you make a decision; Caliber measures whether your judgment is any good — and shows you exactly where it fails."_
...
SITE_URL=                     # e.g. https://caliber.app (used in reminder emails)
