...
export const HOW_IT_WORKS = {
  hero: {
    ...
    sub: "You make judgment calls every day — this will ship on time, that hire will work out, I'll stick with the gym this year. Calra checks those calls against what actually happens, so you learn where your confidence is trustworthy — and where it runs ahead of the facts. No math required from you.",
  },

  metaDescription:
    "What calibration is, in plain language: whether your confidence matches reality, how Calra measures it, and why the math grades you while AI only explains.",
  ...
  keyIdea: {
    ...
    paragraphs: [
      ...
      'So no single prediction can be "calibrated" or not — only a whole track record can. That\'s why Calra needs a little history before it can tell you much, and why it gets sharper the longer you use it.',
    ],
    why: {
  ...
  unlocks: {
    ...
    intro:
      'Because calibration is about patterns, the richer read-outs need a bit of data before they mean anything. A curve built from eight predictions is noise — the same way a coin isn\'t "biased" for landing heads three times out of four. So Calra waits until a number actually means something, rather than guessing early. You get an exact score on your very first resolution; the bigger pictures arrive as you go:',
    items: [
      {
        n: "~10",
