...
export const metadata = {
  title: "Privacy Policy · Aftercast",
  description: "What Aftercast collects, where it's stored, and who processes it.",
};
...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" updated="July 24, 2026">
      <p>
        Aftercast is a free, non-commercial personal project operated by an individual. This policy
        explains what data Aftercast collects, where it&apos;s stored, who processes it, and the choices
      ...
      <LegalSection heading="What we collect">
        ...
        <p>
          Aftercast is free, so we don&apos;t collect payment details, and we don&apos;t use third-party
      ...
      <LegalSection heading="Children">
        <p>
          Aftercast isn&apos;t intended for anyone under 16. Please don&apos;t use it if you&apos;re
