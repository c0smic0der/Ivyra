...
export const metadata = {
  title: "Terms of Service · Aftercast",
  description: "The terms for using Aftercast, a free calibration journal.",
};
...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Service" updated="July 24, 2026">
      <p>
        By using Aftercast you agree to these terms. If you don&apos;t agree, please don&apos;t use it.
        Aftercast is a free, non-commercial personal project operated by an individual.
      </p>

      <LegalSection heading="What Aftercast is — and isn't">
        <p>
          Aftercast is a tool for logging real-life predictions, resolving them when the date arrives,
      ...
      <LegalSection heading="Eligibility">
        <p>You must be at least 16 years old to use Aftercast.</p>
      </LegalSection>

      <LegalSection heading="Your content">
        <p>
          You keep ownership of everything you write, and you&apos;re responsible for what you log. By
          using Aftercast you give us permission to store and process your content in order to operate the
      ...
      <LegalSection heading="AI-generated content">
        <p>
          Aftercast uses AI to narrate patterns in your own data. Your calibration scores are calculated
      ...
      <LegalSection heading="Availability">
        <p>
          Aftercast is provided free of charge, &ldquo;as is&rdquo; and &ldquo;as available.&rdquo; We may
      ...
      <LegalSection heading="No warranty">
        <p>
          To the fullest extent permitted by law, Aftercast is provided without warranties of any kind,
      ...
      <LegalSection heading="Limitation of liability">
        <p>
          To the fullest extent permitted by law, the operator of Aftercast will not be liable for any
          indirect, incidental, special, or consequential damages, or for any loss of data, profits,
          or goodwill, arising out of or relating to your use of (or inability to use) Aftercast. Because
          Aftercast is provided free of charge, our total liability to you for any claim is limited to
          zero.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="Changes to these terms">
        <p>
          ...
          &ldquo;last updated&rdquo; date. Continuing to use Aftercast after a change means you accept the
          updated terms.
        </p>
      </LegalSection>
